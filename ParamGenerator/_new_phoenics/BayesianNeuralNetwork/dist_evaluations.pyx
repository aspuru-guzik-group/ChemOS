...
cdef class DistEvaluator:
	...
	def __init__(self, mus_float, sds_float, mus_int, sds_int, cat_probs, losses, var_types):
...
#					print('VAR TYPES', var_types[dim_index])
...
#						total_prob *= _gauss(x[dim_index], mus_int[sample_index, obs_index, dim_index], sds_int[sample_index, obs_index, dim_index])
