...
class VarDictParser(object):
	...
	def _store_all_infos(self):
		...
		for attr in ['var_sizes', 'var_names', 'var_lows', 'var_highs', 'var_types', 'var_options', 'var_keep_num']:
			setattr(self, attr, [])
		for attr in ['var_p_sizes', 'var_p_names', 'var_p_lows', 'var_p_highs', 'var_p_types', 'var_p_options', 'var_p_keep_num']:
			setattr(self, attr, [])
		for attr in ['var_e_sizes', 'var_e_names', 'var_e_lows', 'var_e_highs', 'var_e_types', 'var_e_options', 'var_e_begin', 'var_e_end', 'var_e_keep_num']:
			setattr(self, attr, [])
		...
		for attr in ['var_sizes', 'var_names', 'var_lows', 'var_highs', 'var_types', 'var_options']:
			setattr(self, attr, np.array(getattr(self, attr)))
		for attr in ['var_p_sizes', 'var_p_names', 'var_p_lows', 'var_p_highs', 'var_p_types', 'var_p_options']:
			setattr(self, attr, np.array(getattr(self, attr)))
		for attr in ['var_e_sizes', 'var_e_names', 'var_e_lows', 'var_e_highs', 'var_e_types', 'var_e_options']:
			setattr(self, attr, np.array(getattr(self, attr)))
